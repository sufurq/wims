                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                            ...
                            <?php foreach ($row as $rows): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button style="margin-right:15px;" type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal<?php echo htmlspecialchars($rows['id']); ?>">
                        ...
                        <a href="./logic/delete_pod.php?id=<?= $rows['id'] ?>" class="btn btn-danger btn-sm">Delete</a>
                         ...
                         <!-- Edit Modal content -->
                                <div class="modal fade" id="editModal <?=htmlspecialchars($rows['id']) ?>"  tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form method="post" action="./logic/edit.php">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editModalLabel">EDIT POD</h5>
